...
//    public static final String CONCURRENT_USER_INFO_TOPIC = "concurrent-test2";
    public static final String CONCURRENT_USER_INFO_TOPIC = "consumer-group-test-2";
    ...
    public static final String CONSUMER_GROUP_TOPIC  = "consumer-group-test-2";
